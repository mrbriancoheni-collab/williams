...
<section class="section-padding" style="background:var(--color-gray-100);">
	<div class="container">
		<div class="section-header center">
			...
			<p class="section-subtitle">
				<?php esc_html_e( 'Williams Pool Care serves homeowners throughout Sacramento and Placer Counties. Find your city below.', 'aquapro' ); ?>
			</p>
		</div>
		<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:16px;margin-top:40px;">
			<?php foreach ( $locations as $loc_slug => $loc ) :
